...
function App() {
  ...
  const getAllMovies = async () => {
    ...
    console.log( 'console' , typeof res) // to remove
  ...
  return (
    <div className="font color-body main-container">
      <div className='direction' id='directionUp' >
      <a href="#home"  ><i className="fa fa-arrow-up"></i></a>
      </div>
      <div className='direction' id='directionDown'>
      <a href="#footer"><i className="fa fa-arrow-down"></i></a>
      </div>
